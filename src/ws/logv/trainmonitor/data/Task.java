...
public class Task<T> extends AsyncTask<Context, Integer, T> {
	...
	public Task(Func<T, Context> func, Action<T> callback)
	{
		this.toExcec = func;
        this.toExcec2 = null;
    ...
    public Task(Func2<T, Context, Action<Integer>> func, Action<T> callback, Action<Integer> progress)
    {
        this.toExcec2 = func;
        this.toExcec = null;
        this.callback = callback;
